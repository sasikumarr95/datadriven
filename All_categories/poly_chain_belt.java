...
public class poly_chain_belt {
	...
	public static void main(String[] args) {
		...
		WebElement polychain = driver.findElement(By.linkText("Poly Chain Belts"));
		polychain.click();
		
		WebElement belt1 = driver.findElement(By.id("ContentPlaceHolder1_rptProducts_imgProduct_0"));
		belt1.click();
		...
		System.out.println("(POLT_CHAIN_BELT)  TEST HAS BEEN DON SUCCESSFULLY");
