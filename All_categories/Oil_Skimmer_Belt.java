...
public class Oil_Skimmer_Belt {
	...
	public static void main(String[] args) {
		...
		WebElement oilskimmer = driver.findElement(By.linkText("Oil Skimmer Belts"));
		oilskimmer.click();
		...
		System.out.println("(OIL_SKIMMER_BELT)  TEST HAS BEEN DON SUCCESSFULLY");
	}
