...
public class Timing_Belts {
	...
	public static void main(String[] args) {
		...
		WebElement roundbelt = driver.findElement(By.linkText("Timing Belts"));
		roundbelt.click();
		...
		System.out.println("Timing BeltsT)  TEST HAS BEEN DON SUCCESSFULLY");
	}
