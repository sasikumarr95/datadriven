...
public class HTD_Timing_Belt {
	...
	public static void main(String[] args) {
		...
		WebElement HTDtimingbelt = driver.findElement(By.linkText("HTD Timing Belts"));
		HTDtimingbelt.click();
		...
		WebElement product15 = driver.findElement(By.id("ContentPlaceHolder1_rptProducts_imgProduct_12"));
		product15.click();
		
		WebElement addbelt15 = driver.findElement(By.id("ContentPlaceHolder1_rptProductDetail_btn1_0"));
		addbelt15.click();
		...
		System.out.println("(HTD TIMING BELT)  TEST HAS BEEN DON SUCCESSFULLY");
	}
