...
public class Cogged_Belts {
	...
	public static void main(String[] args) {
		...
		WebElement CoggedBelts = driver.findElement(By.linkText("Cogged Belts"));
		CoggedBelts.click();
		...
		System.out.println("(COGGED BELTS) TEST HAS BEEN DON SUCCESSFULLY");
